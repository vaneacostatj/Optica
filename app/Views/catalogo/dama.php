...
<ul class="list-group list-group-flush">
  ...
  <li class="list-group-item list-group-item-info active"><a class="btn" href="<?php echo base_url(); ?>/public/catalogoDama">Linea Femenina</a></li>
