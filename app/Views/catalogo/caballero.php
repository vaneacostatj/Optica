...
<ul class="list-group list-group-flush">
  ...
  <li class="list-group-item list-group-item-info active"><a class="btn" href="<?php echo base_url(); ?>/public/catalogoCaballero">Linea Masculina</a></li>
  ...
  <li class="list-group-item list-group-item-info"><a class="btn" href="<?php echo base_url(); ?>/public/catalogoAccesorios">Accesorios</a></li>
</ul>
<br>
</div>
...
<?php foreach ($Lente as $lente): ?>
    ...
    <?php if( $lente['descripcion'] == "caballero"):?>
        <div class="col-sm-4">
