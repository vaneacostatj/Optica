...
<ul class="list-group list-group-flush">
  ...
  <li class="list-group-item list-group-item-info active"><a class="btn" href="<?php echo base_url(); ?>/public/catalogoLentes">Lentes de Contacto</a></li>
...
<?php foreach ($Lente as $lente): ?>
    ...
    <?php if( $lente['descripcion'] == "lentes"):?>
        <div class="col-sm-4">
