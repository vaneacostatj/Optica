...
<ul class="list-group list-group-flush">
  ...
  <li class="list-group-item list-group-item-info active"><a class="btn" href="<?php echo base_url(); ?>/public/catalogoInfantil">Linea Infantil</a></li>
...
<?php foreach ($Lente as $lente): ?>
    ...
    <?php if( $lente['descripcion'] == "infantil"):?>
        <div class="col-sm-4">
